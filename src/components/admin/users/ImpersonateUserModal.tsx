...
export const IMPERSONATING_CLIENT_COOKIE = 'impersonating';
...
function ImpersonateUserModal({
  ...
  useEffect(() => {
    setLoadingImpersonate(isMutating);
  }, [isMutating]);
      ...
      <div className={'flex flex-col space-y-6'}>
        <div className={'flex flex-col space-y-2 text-sm'}>
          ...
          <p>
            ...
            To return to your admin account, use the &quot;Exit impersonation&quot; banner at the top of the page.
          </p>
...
function useImpersonateUser(userId: string) {
  ...
  return useSWRMutation(
    ...
    {
      onSuccess: async () => {
        setCookie(null, IMPERSONATING_CLIENT_COOKIE, '1', {
          path: '/',
          maxAge: 3600,
        });
