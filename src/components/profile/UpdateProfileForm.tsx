...
function UpdateProfileForm({
  ...
  const userInfo = useFetchUserById(user.uid ? user.uid : '');
  ...
  const currentFirstName = userInfo?.name ?? '';
  const currentLastName = userInfo?.lastName ?? '';
    ...
    <>
      <form
        ...
        onSubmit={handleSubmit((value) => {
          const { displayName, firstName, lastName, photoURL } = value;
