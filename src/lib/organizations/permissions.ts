...
/**
 * @name canUpdateTeamMember
 * @param currentUserRole
 * @description Checks if a role can change members data from a team.
 * By default, only Owners and Admin can update members
 */
export function canUpdateTeamMember(
  currentUserRole: MembershipRole,
  isCurrentUser: boolean,
) {
  return currentUserRole >= MembershipRole.Admin || isCurrentUser;
}
 ...
 * By default, only Owners and Admin can update members
 */
export function canUpdateTeamMemberRole(currentUserRole: MembershipRole) {
  return currentUserRole >= MembershipRole.Admin;
}
...
export function canInviteUser(
  ...
  return canInvite && hasGreaterRole;
}
