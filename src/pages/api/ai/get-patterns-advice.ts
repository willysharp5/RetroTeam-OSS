...
import { getPatternsAdviceFromAI } from '~/lib/server/ai/get-patterns-advice';
...
async function onJoinHandler(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        const result = await getPatternsAdviceFromAI(body.comments, body.retrospective, body.totalAiTokens);
