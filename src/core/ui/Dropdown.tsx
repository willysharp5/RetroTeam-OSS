    ...
    <DropdownMenuPrimitive.Content
      ...
      className={classNames(
        'animate-in data-[side=bottom]:slide-in-from-top-2 w-screen md:w-auto' +
          ...
          ' overflow-hidden border rounded-md shadow-md' +
...
>(({ className, inset, clickable = true, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={classNames(
      'relative flex h-11 w-full rounded-md ' +
        ' px-2 text-sm font-medium outline-none focus:outline-none' +
        ' data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      {
        'pl-8': inset,
        [`transition-colors duration-300 focus:bg-primary-50 active:bg-primary-100`]:
          clickable,
      },
      className,
    )}
